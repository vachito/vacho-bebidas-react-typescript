...
export default function GenerateAI() {
  ...
  const handleSubmit = async (e: SubmitEvent<HTMLFormElement>) => {
    ...
    if (prompt.trim() === "") {
      notification({
        text: "Debe ingresar una receta para la busqueda",
        error: true,
      });
      return;
    }
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="flex flex-col space-y-3 py-10">
          <div className="relative">
            ...
            <button
              ...
              className={
                isGenerating
                  ? `text-gray-300 cursor-not-allowed absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2`
                  : `cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2`
              }
        ...
        {isGenerating && (
          <p className="animate-pulse text-center">Generando...</p>
        )}
